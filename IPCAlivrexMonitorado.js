...
async function graficoIgpm() {
  ...
  const request = await fetch('https://api.bcb.gov.br/dados/serie/bcdata.sgs.4449/dados/ultimos/7?formato=json')
  const request2 = await fetch(`https://api.bcb.gov.br/dados/serie/bcdata.sgs.11428/dados/ultimos/7?formato=json`)
  ...
  const chart3 = new google.visualization.LineChart(document.getElementById('IPCAlivre'));
